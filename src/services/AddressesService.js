...
class AddressesService {
	...
	static async count(jwt) {
		try {
			...
			console.error('Error in get of AddressesService:', error);
			throw error;
		}
	}
	...
	static async createOne(jwt, label, description = '') {
		try {
			...
			console.error('Error in createOne of AddressesService:', error);
			throw error;
		}
	}
	...
	static async deleteOne(jwt, id) {
		try {
			...
			console.error('Error in deleteOne of AddressesService:', error);
			throw error;
		}
	}
	 ...
	 */
		static async updateOne(jwt, id, modifWanted) {
			try {
				...
				console.error('Error in updateOne of AddressesService:', error);
				throw error;
			}
		}
}
